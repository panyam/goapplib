...
const (
	...
	UsersServiceName = "goapplib.v1.UsersService"
)
...
// NewUsersServiceClient constructs a client for the goapplib.v1.UsersService service. By default,
...
func NewUsersServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UsersServiceClient {
	...
	usersServiceMethods := v1.File_goapplib_v1_users_proto.Services().ByName("UsersService").Methods()
...
// CreateUser calls goapplib.v1.UsersService.CreateUser.
...
// GetUser calls goapplib.v1.UsersService.GetUser.
...
// GetUsers calls goapplib.v1.UsersService.GetUsers.
...
// ListUsers calls goapplib.v1.UsersService.ListUsers.
...
// UpdateUser calls goapplib.v1.UsersService.UpdateUser.
...
// DeleteUser calls goapplib.v1.UsersService.DeleteUser.
...
// UsersServiceHandler is an implementation of the goapplib.v1.UsersService service.
...
func NewUsersServiceHandler(svc UsersServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/goapplib.v1.UsersService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUsersServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("goapplib.v1.UsersService.CreateUser is not implemented"))
}
...
func (UnimplementedUsersServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("goapplib.v1.UsersService.GetUser is not implemented"))
}
...
func (UnimplementedUsersServiceHandler) GetUsers(context.Context, *connect.Request[v1.GetUsersRequest]) (*connect.Response[v1.GetUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("goapplib.v1.UsersService.GetUsers is not implemented"))
}
...
func (UnimplementedUsersServiceHandler) ListUsers(context.Context, *connect.Request[v1.ListUsersRequest]) (*connect.Response[v1.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("goapplib.v1.UsersService.ListUsers is not implemented"))
}
...
func (UnimplementedUsersServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("goapplib.v1.UsersService.UpdateUser is not implemented"))
}
...
func (UnimplementedUsersServiceHandler) DeleteUser(context.Context, *connect.Request[v1.DeleteUserRequest]) (*connect.Response[v1.DeleteUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("goapplib.v1.UsersService.DeleteUser is not implemented"))
}
